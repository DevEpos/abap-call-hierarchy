...
CLASS zcl_acallh_compilation_unit DEFINITION
  PUBLIC
  FINAL
  CREATE PRIVATE
  GLOBAL FRIENDS zcl_acallh_comp_unit_factory.

  PUBLIC SECTION.
    INTERFACES zif_acallh_compilation_unit.

    METHODS:
      constructor
        IMPORTING
          hierarchy_service TYPE REF TO zif_acallh_call_hierarchy_srv
          data              TYPE zif_acallh_ty_global=>ty_compilation_unit
        RAISING
  ...
  PRIVATE SECTION.
    ALIASES:
      unit_info FOR zif_acallh_compilation_unit~unit_info.

    TYPES:
      BEGIN OF ty_comp_unit_by_line,
        line TYPE i,
        ref  TYPE REF TO zif_acallh_compilation_unit,
    ...
    DATA:
      ...
      called_units               TYPE zif_acallh_compilation_unit=>ty_ref_tab.
ENDCLASS.



CLASS zcl_acallh_compilation_unit IMPLEMENTATION.
  ...
  METHOD zif_acallh_compilation_unit~get_called_units.
  ...
  METHOD zif_acallh_compilation_unit~get_call_position_uri.
**********************************************************************
...
**********************************************************************
    IF unit_info-include IS INITIAL.
      RETURN.
    ENDIF.
